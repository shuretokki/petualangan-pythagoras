...
<template>
    <div
        class="min-h-screen bg-[#FAFAFA] flex flex-col relative font-sans text-slate-900 pb-10"
    >
        <div class="p-8 pt-12 flex flex-col items-center text-center z-10">
            ...
            >
                ...
                <img
                    :src="mascot"
                    class="w-full h-full object-contain transition-transform duration-300 animate-float"
                />
            </div>
        ...
        <div class="px-6 w-full max-w-sm mx-auto grid grid-cols-2 gap-4">
            <div
            ...
            >
                ...
                <div :class="{ 'text-right': i === 2 }">
                    <h3 class="font-recoleta text-xl font-bold text-slate-800">
                        {{ item.label }}
                    </h3>
