...
<template>
    <div class="min-h-screen gray-50 pt-20">
            ...
            <div class="max-w-4xl mx-auto">
                    ...
                    <div class="bg-white/90 rounded-full p-2 mb-8 shadow-lg">
                        <div class="flex justify-between items-center px-4">
                            <span class="text-sm font-semibold text-gray-700">
                                Soal
                                {{ quizStore.currentQuestionIndex + 1 }} dari
                                {{ quizStore.totalQuestions }}
                            </span>
                            <div
                                class="flex-1 mx-4 bg-gray-200 rounded-full h-2"
                            >
                                <div
                ...
                >
                    <div class="bg-white/95 rounded-2xl p-12 shadow-2xl">
                        ...
                        <div
                            class="text-7xl font-bold bg-clip-text text-transparent mb-6"
                        >
                            {{ quizStore.score }}%
                        </div>
                        ...
                        <div class="flex gap-4 justify-center">
                            <button
                                @click="restartQuiz"
                                class="px-8 py-4 text-white rounded-full font-bold shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-200"
                            >
                                🔄 Ulangi Kuis
                            </button>
                            <button
