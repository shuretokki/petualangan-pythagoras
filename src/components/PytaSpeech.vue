...
<template>
    <div class="relative w-full max-w-sm mx-auto mt-4 z-20">
        ...
        <div
            class="relative rounded-lg border-2 px-6 py-5 min-h-[90px] flex items-center transition-all duration-300"
        ...
        >
            ...
            <div
                class="absolute -bottom-[9px] left-8 w-4 h-4 bg-white border-b-2 border-r-2 transform rotate-45"
                :class="
                    variant === 'violet'
                        ? 'border-violet-200'
                        : 'border-emerald-200'
